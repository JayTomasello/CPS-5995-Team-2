...
<head>
    ...
    <title>LD4NJ - View Disclaimer</title>
...
<body class="container align-middle justify-content-center" style="background-image: url(./Courthouse.jpg); background-size:cover; background-position:center -100px">
    ...
    <div class="z-3 position-absolute top-50 start-50 translate-middle p-4 rounded-3" style="background-color:beige">
        <h1 style="text-align: center">This agreement is required to use Legal Digest 4 New Jersey</h1>
        <h2>DISCLAIMER</h2>
        ...
        <button class="btn btn-primary mx-2"><a class="text-white" href="session_agree.php">Agree</a></button>
    </div>
