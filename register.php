    ...
    <div class="container">
        <div class="row justify-content-center">
            <form class="col-lg-6 col-md-8 col-sm-10 text-center m-5" action="" method="POST">
                ...
                <h3 class="card-title">Register as a Subscribed User</h3>
                <div class="mb-3">
...
<?php
                echo "<br><h3 style='color: red;' class='text-center'>Passwords do not match</h3>";
            } else {
                if (
                    ...
                    <?php
                    echo "<br><h3 style='color: red;' class='text-center'>Error: Password must be at least 8 characters long and contain at least one uppercase letter, one number, and one special character.</h3>";
                } else {
                    ...
                    <div class='row justify-content-center'>";
                    echo "<h2 class='text-center'><br><br>A verification code has been sent to $email. Please input it below to complete your account registration.</h2>";
                    echo "<form class='col-lg-6 col-md-8 col-sm-10 text-center m-5' action='' method='POST'>";
                    echo "<div class='mb-3'>
        ...
        if (isset($_POST['Verify'])) {
            ...
            if ($input_code2 != $verif_code2) {
                echo "<div class='container'>
                    <div class='row justify-content-center'>";
                echo "<h3 class='text-center'><br><br>A verification code has been sent to $email2. Please input it below to complete your account registration.</h3>";
                echo "<form class='col-lg-6 col-md-8 col-sm-10 text-center m-5' action='' method='POST'>";
                echo "<div class='mb-3'>
                        <input name='Verification' type='number' class='form-control' placeholder='Enter Verification Code' required>
                    </div>";
                ...
                echo "<button name='Verify' type='submit' value='submit' class='btn btn-primary'>Verify Code</button>
                    ...
                    echo "<h4 style='color: red;' class='text-center'>Error: Verification code does not match</h4>";
                    echo "</div>
                    </div>";
            } else {
...
if (!isset($_POST['Enter']) && !isset($_POST['Verify'])) {
